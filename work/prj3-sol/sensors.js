...
class Sensors {
  ...
  async addSensorType(info) {
    ...
    sensorType.self = "http://localhost:2345/sensor-types/" + sensorType.id
  ...
  async addSensor(info) {
    ...
    sensor.self = "http://localhost:2345/sensors/" + sensor.id
  ...
  async addSensorData(info) {
    ...
    collection.self = "http://localhost:2345/sensor-data/" + sensorData.sensorId + "/" + sensorData.timestamp
